...
<h3 align="center">Welcome to my Arctic Delights project! 🍨<br> We appreciate your interest in contributing.😊 <br>This guide will help you get started with the project and make your first contribution.</h3>
...
- Take a look at the existing [**Issues**](https://github.com/dohinaf/basic-icecream-website/issues). 
- Fork the Repo & create a branch for any issue that you are working on and commit your work.
- At first raise an issue in which you want to work
- Then after assigning only then work on that issue & make a PR 
- Create a [**Pull Request**](https://github.com/dohinaf/basic-icecream-website/pulls), which will be promptly reviewed and given suggestions for improvements by the community.
